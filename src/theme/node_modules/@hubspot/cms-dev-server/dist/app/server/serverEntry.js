...
import { Check, CircleCheck, TriangleAlert, ExternalLink, Copy, ClipboardCopy, X, Braces, ServerCrash, ArrowRightLeft, Sun, Moon } from "lucide-react";
...
var ClientRenderContextProvider = ({
  ...
  const contextValue = {
    ...
    resolvedDataDependencies: island == null ? void 0 : island.resolvedDataDependencies
  };
  useLayoutEffect(() => {
...
var supportedTemplateTypeMap = { page: 4 };
...
const IconButton = ({ text, url, Icon: Icon2, className }) => /* @__PURE__ */ jsx(Button, { variant: "ghost", className, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
  Icon2 && /* @__PURE__ */ jsx(Icon2, { className: "w-6 h-6 mr-2 text-primary dark:text-primary-default" }),
  ...
  return /* @__PURE__ */ jsxs(Tooltip, { delayDuration: 100, children: [
    /* @__PURE__ */ jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx(
      Button,
      {
        variant: "outline",
        size: "icon",
        className: `w-10 h-10 min-w-10 p-0 flex items-center justify-center bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 ${isCircle ? "rounded-full" : ""}`,
        onClick: handleClick,
    ...
    /* @__PURE__ */ jsx(
      ...
      {
        side: "bottom",
        className: "max-w-[200px] font-medium dark:bg-gray-800",
...
const WhiteBox = ({ count, label, subText, onClick }) => /* @__PURE__ */ jsxs(
  ...
  {
    onClick,
    className: "flex-1 md:flex-none md:w-[170px] h-36 px-8 py-6 bg-card text-card-foreground dark:bg-card dark:text-card-foreground rounded-lg flex flex-col justify-center items-center gap-1 cursor-pointer",
    children: [
...
const CLICommands = ({
  cliCommands = []
}) => /* @__PURE__ */ jsx("div", { className: "flex flex-col justify-end items-start min-h-36 p-6 bg-slate-900 dark:bg-card rounded-xl gap-6 overflow-hidden", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-start items-start gap-6 w-full", children: [
  /* @__PURE__ */ jsx("div", { className: "text-white dark:text-gray-100 text-xl font-medium leading-7", children: "Copy CLI Commands" }),
  /* @__PURE__ */ jsx("div", { className: "grid grid-cols-[repeat(auto-fit,minmax(100px,1fr))] auto-cols-fr gap-2 w-full px-1 py-1 bg-white dark:bg-gray-800 rounded-md border border-slate-300 dark:border-0 text-black dark:text-gray-100 text-sm font-medium leading-tight", children: cliCommands && cliCommands.map(({ scriptName, description, runCommand }) => /* @__PURE__ */ jsxs(Tooltip, { delayDuration: 100, children: [
    /* @__PURE__ */ jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx("div", { className: "h-8 px-3 py-1.5 dark:bg-gray-800 hover:bg-accent dark:hover:bg-accent hover:text-accent-foreground dark:hover:text-accent-foreground flex items-center justify-center relative group cursor-pointer max-w-[200px] mx-auto w-full rounded-md text-foreground", children: /* @__PURE__ */ jsx("span", { children: scriptName }) }) }),
    /* @__PURE__ */ jsxs(
      TooltipContent,
      {
        side: "bottom",
        className: "bg-white dark:bg-slate-800 font-medium p-4",
        children: [
...
const Hero = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full h-full bg-gray-200 dark:bg-gray-800 rounded-3xl px-10 py-8 transition-colors", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-gray-900 dark:text-gray-100 text-2xl font-semibold flex items-center gap-2 leading-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsx(
          IconButton,
          {
            ...
            Icon: ExternalLink,
            url: "https://developers.hubspot.com/docs/guides/cms/quickstart/react-plus-hubl-quickstart",
            className: "hidden lg:block"
          }
        ),
    ...
    projectName && /* @__PURE__ */ jsx("div", { className: "w-full text-gray-900 dark:text-gray-100 font-inter text-4xl font-extrabold mt-5 mb-4", children: projectName }),
    /* @__PURE__ */ jsx("div", { className: "flex items-center space-x-4 text-gray-900 dark:text-gray-100 font-inter text-sm font-light", children: authedPortalId && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
...
const TableRow = React.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "tr",
  {
    ref,
    className: cn(
      "border-b transition-colors data-[state=selected]:bg-muted hover:bg-muted/50 dark:hover:bg-muted/30",
      className
    ),
    ...props
  }
  ...
  return /* @__PURE__ */ jsxs(
    Table,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { className: "overflow-y-auto", children: pages.map((page, index) => /* @__PURE__ */ jsxs(TableRow, { className: "odd:bg-background even:bg-muted/50", children: [
          /* @__PURE__ */ jsx(TableCell, { className: "border", children: /* @__PURE__ */ jsxs(
            "a",
            {
              href: getPageEditorUrl(authedPortalId, page.id, authedEnv),
              target: "_blank",
              className: "underline flex items-center gap-1 text-foreground",
              children: [
                page.label,
                /* @__PURE__ */ jsx(ExternalLink, { className: "w-4 h-4 text-foreground" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsx(TableCell, { className: "border text-foreground", children: formatSubType(page.subType) })
        ] }, index)) })
      ]
    }
  );
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
    ...
    codeString ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs("div", { className: "relative mt-6 mb-3", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "rounded-xl overflow-hidden p-4 bg-[#0F172A] dark:bg-gray-800", children: /* @__PURE__ */ jsx("pre", { className: "text-[14px] font-medium leading-6 text-[#9CDCFE] whitespace-pre-wrap", children: codeString }) })
      ] }),
    ...
    /* @__PURE__ */ jsxs(
      SheetContent,
      {
        ...
        children: [
          ...
          projectName ? /* @__PURE__ */ jsx("div", { className: "grid gap-6 pb-6 my-6 border-b border-gray-300 dark:border-gray-700", children: /* @__PURE__ */ jsx(
  ...
  return /* @__PURE__ */ jsxs(
    Table,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { className: "overflow-y-auto", children: componentList.map((component, index) => /* @__PURE__ */ jsxs(TableRow, { className: "odd:bg-background even:bg-muted/50", children: [
          ...
          component.type && /* @__PURE__ */ jsx(TableCell, { className: "border", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            component.type === "react" ? /* @__PURE__ */ jsx(ReactIcon, {}) : /* @__PURE__ */ jsx(Braces, { className: "text-foreground" }),
...
const ComponentTableListItem = ({
  ...
  return /* @__PURE__ */ jsxs("div", { id: id2, className: "mb-16", children: [
    /* @__PURE__ */ jsx("h2", { className: "font-inter text-2xl font-semibold leading-9 tracking-tight text-left mb-6 text-foreground", children: header }),
    subtext && /* @__PURE__ */ jsx("p", { className: "font-inter text-base font-normal leading-7 text-left mb-5 text-foreground/80", children: subtext }),
    /* @__PURE__ */ jsx(
      ComponentTable,
      {
        authedEnv,
...
const ComponentTableList = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-12 font-inter text-foreground", children: [
    /* @__PURE__ */ jsx(
...
const Footer = () => {
  const links = [
    ...
    {
      href: "https://developers.hubspot.com/docs/guides/cms/react/overview",
      text: "CMS React Docs"
    },
    {
  ...
  return /* @__PURE__ */ jsx("footer", { className: "w-full py-16", children: /* @__PURE__ */ jsx("nav", { className: "flex justify-center items-center gap-4 text-muted-foreground text-sm font-normal", children: links.map((link, index) => /* @__PURE__ */ jsxs(React__default.Fragment, { children: [
...
function ThemeProvider({
  children,
  defaultTheme = "system",
  storageKey = "cms-dev-server-theme",
  ...props
}) {
...
function ThemeToggle() {
  ...
  return /* @__PURE__ */ jsxs(
    Button,
    {
      ...
      className: "rounded-full w-10 h-10 bg-white dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-transform duration-200 ease-in-out hover:scale-110 hover:rotate-12",
      "aria-label": "Toggle theme",
      children: [
        /* @__PURE__ */ jsx(Sun, { className: "h-5 w-5 rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0 text-amber-500" }),
        /* @__PURE__ */ jsx(Moon, { className: "absolute h-5 w-5 rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100 text-gray-400" }),
...
function App({
  ...
  return /* @__PURE__ */ jsx(ThemeProvider, { defaultTheme: "system", storageKey: "cms-dev-server-theme", children: /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs("div", { className: "container relative pt-8 bg-background text-foreground", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute right-4 top-4 z-10 p-1 rounded-full bg-gray-200 dark:bg-gray-800 shadow-sm", children: /* @__PURE__ */ jsx(ThemeToggle, {}) }),
    /* @__PURE__ */ jsx(
      Hero,
      {
        projectName,
